...
public class HistoryDetailsActivity extends AppCompatActivity {
    ...
    private String renterCodeHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_details2);
        getExtras();
        setupWidgets();
        setupToolbar();
        setupFirebase();
    ...
    private CarSettings getUserSettings(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot ds: dataSnapshot.getChildren()) {
            if(ds.getKey().equals("UDFile")) {
                udFile = ds.child(renterCodeHolder).getValue(UDFile.class);
            }
            if(ds.getKey().equals("UHFile")) {
                uhFile = ds.child(renterCodeHolder).getValue(UHFile.class);
            }
...
//        timer.scheduleAtFixedRate(new MyTimerTask(), 2000, 4000);
    ...
    private void getExtras() {
        ...
        renterCodeHolder = b.getString("rentercode");
